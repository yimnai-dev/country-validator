...
test('Get states of passed country', () => {
    expect((0, __1.getCountryStates)({ name: 'Cameroon' })).toEqual(data_1.STATES['CAMEROON']);
    expect((0, __1.getCountryStates)({ dial_code: '+237' })).toEqual(data_1.STATES['CAMEROON']);
    expect((0, __1.getCountryStates)({ code: 'CM' })).toEqual(data_1.STATES['CAMEROON']);
    //@ts-expect-error Passing a wrong country code | name | dialcode should fail
    expect((0, __1.getCountryStates)({ code: 'CMs' })).toEqual(undefined);
});
